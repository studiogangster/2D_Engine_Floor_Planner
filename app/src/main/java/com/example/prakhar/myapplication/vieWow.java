 ...
 */
public class vieWow extends View {
...
Context con;
    public vieWow(Context context) {
        super(context);
     init(context);
    }

    public vieWow(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public vieWow(Context context, AttributeSet attrs, int defStyleAttr) {
