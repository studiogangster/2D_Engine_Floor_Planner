 ...
 */
public class vie45 extends View {
...
Context con;
    public vie45(Context context) {
        super(context);
     init(context);
    }

    public vie45(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public vie45(Context context, AttributeSet attrs, int defStyleAttr) {
