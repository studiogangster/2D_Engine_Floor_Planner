 ...
 */
public class vie4 extends View {
...
drawPolygons();
    ...
    public vie4(Context context) {
        super(context);
     init();
    }

    public vie4(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public vie4(Context context, AttributeSet attrs, int defStyleAttr) {
