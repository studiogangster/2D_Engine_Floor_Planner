 ...
 */
public class vie3 extends View {
...
drawPolygons();
    ...
    public vie3(Context context) {
        super(context);
     init();
    }

    public vie3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public vie3(Context context, AttributeSet attrs, int defStyleAttr) {
