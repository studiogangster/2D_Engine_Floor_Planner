 ...
 */
public class vieWorkingRot extends View {
    void deselectAll()
    {
...
Context con;
    public vieWorkingRot(Context context) {
        super(context);
     init(context);
    }

    public vieWorkingRot(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public vieWorkingRot(Context context, AttributeSet attrs, int defStyleAttr) {
...
int CNTR = 0;
     void rotate(int id_selected) {
polygons.get(id_selected).rotateBy(Math.PI/180);
